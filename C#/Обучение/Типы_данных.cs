...
namespace Обучение
{
    class Типы_данных
    {
        public void данные()
        {
            ...
            Console.WriteLine($"byte(8bit) - {250}\n");
            ...
            Console.WriteLine($"float(---) - {123.456f}\n");
            Console.WriteLine($"double(---) - {123.4567890f}\n");
            Console.WriteLine($"decimal(---) - {123456.789}\n");
            Console.WriteLine($"char(---) - {"x"}\n");
            Console.WriteLine($"unlong(---) - {"hello"}\n");
        }
    }
}
